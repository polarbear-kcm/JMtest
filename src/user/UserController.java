...
// http://localhost:8090/assacamping/userCon/listUsers.do로 요청

//2. 회원가입 디자인 페이지로 이동
//<a href = "/assacamping/userCon/userForm.do">
//http://localhost:8090/assacamping/userCon/userForm.do

//userForm.jsp에서 가입할 회원정보를 입력 한 후 DB에 INSERT 요청
//http://localhost:8090/assacamping/userCon/addUser.do
